    ...
    public class Program
    {
        ...
        static void Main()
        {
            ...
            builder.AppendFormat("{0} {1} {2} {3}"
                , "Не верить императору Константину глупо. В описываемую эпоху Византия"
                , "переживала далеко не лучшие времена и событие такого масштаба, как"
                , "приобщение к истинной вере северных варваров, бесперечь тревоживших"
                , "рубежи империи, просто не могло остаться без комментариев жителей."
            );
